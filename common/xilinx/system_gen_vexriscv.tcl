...
set_property CONFIG.NUM_MI 9 [get_bd_cells axi_interconnect]
...
set_property CONFIG.C_USE_STARTUP {0} [get_bd_cells axi_quad_spi]
...
connect_bd_net [get_bd_pins /axi_quad_spi/io0_i] [get_bd_ports spi_io0_i]

create_bd_port -dir O spi_io0_o
connect_bd_net [get_bd_pins /axi_quad_spi/io0_o] [get_bd_ports spi_io0_o]

create_bd_port -dir O spi_io0_t
connect_bd_net [get_bd_pins /axi_quad_spi/io0_t] [get_bd_ports spi_io0_t]

create_bd_port -dir I spi_io1_i
connect_bd_net [get_bd_pins /axi_quad_spi/io1_i] [get_bd_ports spi_io1_i]

create_bd_port -dir O spi_io1_o
connect_bd_net [get_bd_pins /axi_quad_spi/io1_o] [get_bd_ports spi_io1_o]

create_bd_port -dir O spi_io1_t
connect_bd_net [get_bd_pins /axi_quad_spi/io1_t] [get_bd_ports spi_io1_t]

create_bd_port -dir I spi_sck_i
connect_bd_net [get_bd_pins /axi_quad_spi/sck_i] [get_bd_ports spi_sck_i]

create_bd_port -dir O spi_sck_o
connect_bd_net [get_bd_pins /axi_quad_spi/sck_o] [get_bd_ports spi_sck_o]

create_bd_port -dir O spi_sck_t
connect_bd_net [get_bd_pins /axi_quad_spi/sck_t] [get_bd_ports spi_sck_t]

create_bd_port -dir I -from 0 -to 0 spi_ss_i
connect_bd_net [get_bd_pins /axi_quad_spi/ss_i] [get_bd_ports spi_ss_i]

create_bd_port -dir O -from 0 -to 0 spi_ss_o
connect_bd_net [get_bd_pins /axi_quad_spi/ss_o] [get_bd_ports spi_ss_o]

create_bd_port -dir O spi_ss_t
connect_bd_net [get_bd_pins /axi_quad_spi/ss_t] [get_bd_ports spi_ss_t]
...
connect_bd_intf_net [get_bd_intf_pins axi_quad_spi/AXI_LITE] -boundary_type upper [get_bd_intf_pins axi_interconnect/M05_AXI]
connect_bd_net [get_bd_pins axi_quad_spi/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1]
connect_bd_net [get_bd_pins axi_quad_spi/s_axi_aresetn] [get_bd_pins sys_rstgen/peripheral_aresetn]
...
connect_bd_net [get_bd_pins axi_quad_spi/ip2intc_irpt] [get_bd_pins irq_concat/In3]
...
connect_bd_net [get_bd_pins irq_concat/In4] [get_bd_pins xlconstant_0/dout]
